...
/**
 * Will return the path and yapcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'yapcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'yapcore-node.json'))
  };
}
