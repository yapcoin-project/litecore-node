...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the yapcoin database directory')
  ...
  program
    ...
    .option('-c, --config <dir>', 'Specify the directory with Yapcore Node configuration')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `yapcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ yapcore-node add wallet-service');
      console.log('    $ yapcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ yapcore-node remove wallet-service');
      console.log('    $ yapcore-node remove insight-api');
      console.log();
    });
